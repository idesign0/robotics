...
protected:
    ...
    string highest_qualifications;
public:
    void get_details(){
    cin.ignore();
    cout << "Enter highest education : "; getline(cin,highest_education);
    cout << "Enter highest qualifications : "; getline(cin,highest_qualifications);
    }
    void show_details(){
    cout << "Highest education : " << highest_education<<endl;
    cout << "Highest qualifications : " << highest_qualifications<<endl;
    }
};
// officer class

class officer:virtual public staff,public education{
protected:
    char grade;
public:
    void get_details(){
...
class teacher:virtual public staff, public education{
protected:
    string subject;
    string publication;
public:
